          ...
          child: Center(
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                    ResponsiveHelper.isDesktop(context) ? SizedBox(height: 50,) : SizedBox(height: MediaQuery.of(context).size.width/4,),
                    Container(
                          ...
                          children: [
                            ...
                            Center(
                              child: Padding(
                                ...
                                child: Image.asset(
                                  Images.app_logo,
                                  height: ResponsiveHelper.isDesktop(context) ? MediaQuery.of(context).size.height*0.15 : MediaQuery.of(context).size.height / 6.5,
